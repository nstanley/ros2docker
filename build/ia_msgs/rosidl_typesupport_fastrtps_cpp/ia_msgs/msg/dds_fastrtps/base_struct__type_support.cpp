...
#include "ia_msgs/msg/base_struct__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const ia_msgs::msg::BaseStruct *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ia_msgs::msg::BaseStruct *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _BaseStruct__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ia_msgs::msg::BaseStruct *>(
...
{
  return max_serialized_size_BaseStruct(full_bounded, 0);
}

static message_type_support_callbacks_t _BaseStruct__callbacks = {
  "ia_msgs::msg",
  "BaseStruct",
...
static rosidl_message_type_support_t _BaseStruct__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_BaseStruct__callbacks,
...
{
  return &ia_msgs::msg::typesupport_fastrtps_cpp::_BaseStruct__handle;
}
