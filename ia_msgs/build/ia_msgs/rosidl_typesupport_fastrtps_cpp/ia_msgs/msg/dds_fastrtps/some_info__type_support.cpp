...
#include "ia_msgs/msg/some_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const ia_msgs::msg::BaseStruct &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ia_msgs::msg::BaseStruct &);
...
cdr_serialize(
  const ia_msgs::msg::SomeInfo & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ia_msgs::msg::SomeInfo & ros_message)
{
  // Member: core
  ...
  size_t current_alignment)
{
  ...
  // Member: core
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ia_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_BaseStruct(
...
{
  auto typed_message =
    static_cast<const ia_msgs::msg::SomeInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ia_msgs::msg::SomeInfo *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SomeInfo__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ia_msgs::msg::SomeInfo *>(
...
{
  return max_serialized_size_SomeInfo(full_bounded, 0);
}

static message_type_support_callbacks_t _SomeInfo__callbacks = {
  "ia_msgs::msg",
  "SomeInfo",
...
static rosidl_message_type_support_t _SomeInfo__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SomeInfo__callbacks,
...
{
  return &ia_msgs::msg::typesupport_fastrtps_cpp::_SomeInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ia_msgs, msg, SomeInfo)() {
  return &ia_msgs::msg::typesupport_fastrtps_cpp::_SomeInfo__handle;
}
