...
#include "pkg_one/msg/my_msg__rosidl_typesupport_fastrtps_c.h"
...
#include "pkg_one/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _MyMsg__ros_msg_type = pkg_one__msg__MyMsg;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_pkg_one
size_t get_serialized_size_pkg_one__msg__MyMsg(
  const void * untyped_ros_message,
...
static uint32_t _MyMsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_pkg_one__msg__MyMsg(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_pkg_one
size_t max_serialized_size_pkg_one__msg__MyMsg(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_pkg_one__msg__MyMsg(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pkg_one, msg, MyMsg)() {
