...
class Metaclass_SomeInfo(type):
    """Metaclass of message 'SomeInfo'."""
...
class SomeInfo(metaclass=Metaclass_SomeInfo):
    """Message class 'SomeInfo'."""
    ...
    _fields_and_field_types = {
        'core': 'ia_msgs/BaseStruct',
        'timestamp': 'uint32',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['ia_msgs', 'msg'], 'BaseStruct'),  # noqa: E501
    ...
    def __init__(self, **kwargs):
        ...
        from ia_msgs.msg import BaseStruct
        self.core = kwargs.get('core', BaseStruct())
    ...
    def core(self, value):
        if __debug__:
            from ia_msgs.msg import BaseStruct
            assert \
                isinstance(value, BaseStruct), \
                "The 'core' field must be a sub message of type 'BaseStruct'"
        self._core = value
