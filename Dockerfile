...
# from https://index.ros.org/doc/ros2/Installation/Eloquent/Linux-Install-Debians/
...
RUN sudo apt update
RUN sudo apt install -y ros-eloquent-desktop
# RUN sudo apt install ros-eloquent-ros-base
